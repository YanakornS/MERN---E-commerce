        ...
        <div className="py-24 flex flex-col md:flex-row justify-between items-center">
          ...
          <span className="text-red "> Testimonials</span>
            ...
            <h2 className="md:text-4xl text-4xl font-bold md:leading-snug leading-sung">
              ...
              What Our Customers
              <h3>Say About US </h3>
              <span className="text-[#4A4A4A] text-lg">"As a Software developer i'm always on the lookout for unique 
                accessories to experess my love for coding. The Keyboard Key Keychain is not only stylish but also durable. Will defintely be puchasing more items!"</span> 
            </h2>
